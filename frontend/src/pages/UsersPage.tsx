...
const allPermissions: Permission[] = [
  ...
  { id: "transactions_view", name: "View Transactions", description: "Can view transaction modules (Pick List, Picking, FG Receipt, etc.)", module: "Transactions" },
  { id: "transactions_manage", name: "Manage Transactions", description: "Can create and manage transactions", module: "Transactions" },
